...
e.g., $k=\begin{bmatrix} 1\\0 \end{bmatrix}$, $X=\begin{bmatrix}2\\3\end{bmatrix}$ 일때 $\beta=1$일 경우 ($k$는 단위 벡터)
...
e.g., $k=\begin{bmatrix} 1\\0 \end{bmatrix}$, $X=\begin{bmatrix}2\\3\end{bmatrix}$ 일때 $\beta=2$일 경우 ($k$는 단위 벡터)  
